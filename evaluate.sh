...
timeout $1 /home/jlj/dev/AFL/afl-fuzz -i "$2/testcase" -o "$2/results/base" "$2/$(basename $2)/$3" &
wait
...
timeout $1 /home/jlj/dev/AFL/afl-fuzz -i "$2/testcase" -o "$2/results/instrumented" "$2/$(basename $2)-instrumented/$3" &
wait
