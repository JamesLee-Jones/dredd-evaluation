...
#define REPLACE_BINARY_Sub(type) if ((arg1 - arg2) != actual_result) no_op++
#define REPLACE_BINARY_Rem(type) if ((arg2 != 0) && (arg1 % arg2) != actual_result) no_op++
#define REPLACE_BINARY_Mul(type) if ((arg1 * arg2) != actual_result) no_op++
#define REPLACE_BINARY_Div(type) if ((arg2 != 0) && (arg1 / arg2) != actual_result) no_op++
#define REPLACE_BINARY_ARG2(mutation_id_offset) if ((arg2) != actual_result) no_op++
#define REPLACE_BINARY_ARG1(mutation_id_offset) if ((arg1) != actual_result) no_op++
...
__attribute__((always_inline)) inline static int __dredd_replace_binary_operator_Add_arg1_int_arg2_int(int arg1, int arg2, int local_mutation_id) {
  MUTATION_PRELUDE(arg1 + arg2,int);
  REPLACE_BINARY_Div(int);
